...
<template>
  <header class="relative h-[150vh]">
    ...
    <div class="parallax-vid absolute inset-0 overflow-hidden">
      <video ref="video" src="https://res.cloudinary.com/idorenyinudoh/video/upload/v1755562025/dakar/dakar_crjvjy.mp4" class="object-cover w-full h-[110%]" autoplay muted loop playsinline preload="auto" poster="https://dakar-e7n.pages.dev/dakar-poster.png" />
    </div>
  </header>
</template>